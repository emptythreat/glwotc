...
interface AddListingSlideOutProps {
  isBuyOrder: boolean;
  onClose: () => void;
  onNewOrder: (order: Order) => void;
}

const AddListingSlideOut: React.FC<AddListingSlideOutProps> = ({ isBuyOrder, onClose, onNewOrder }) => {
...
export default AddListingSlideOut;